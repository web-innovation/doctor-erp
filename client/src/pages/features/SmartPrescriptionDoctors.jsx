...
export default function SmartPrescriptionDoctors() {
  return (
    <FeaturePageTemplate
      ...
      subtitle="Docsy ERP’s Smart Prescription Software helps doctors generate clear, digital, and error-free prescriptions within seconds. Designed to reduce handwriting errors and save consultation time, the system allows easy medicine selection, dosage automation, and secure prescription sharing with patients."
      description="Docsy ERP makes prescription writing faster and safer by guiding medicine entry, dosage consistency, and patient-friendly output. Doctors spend more time on diagnosis while staff handles fewer clarification calls."
      points={[
