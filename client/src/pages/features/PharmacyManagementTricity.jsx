  ...
  return (
    <FeaturePageTemplate
      ...
      modules={[
        ...
        'GST billing and invoice printing',
        'Supplier and purchase management',
        'Stock movement and ledger integration',
        'Expiry and low-stock alerts',
        'Daily sales analytics'
      ]}
      industries={[
        'Clinic attached pharmacies',
        'Standalone medical stores',
        'Multi-branch pharmacy chains',
        'Diagnostic center pharmacies'
      ]}
      faqs={[
        {
          q: 'Does this software support GST billing for pharmacies?',
          a: 'Yes. Docsy ERP supports GST-ready pharmacy billing with tax breakup and billing reports.'
        },
        {
          q: 'Can we track stock by batch and expiry date?',
          a: 'Yes. You can track stock at product and batch level including expiry visibility.'
        },
        {
          q: 'Can pharmacy sales sync with clinic prescriptions?',
          a: 'Yes. Prescription and pharmacy workflows are connected to reduce dispensing errors and re-entry work.'
        }
      ]}
    />
  );
