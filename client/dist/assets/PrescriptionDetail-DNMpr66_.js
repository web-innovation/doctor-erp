import{T as V,u as B,r as R,p as Q,j as e,l as X,a5 as _,a6 as G,g as K,$ as Y,a8 as Z,a9 as J,aa as ee,Z as se,ab as te,Q as ae,a7 as ie,n as le,z as x}from"./index-DPyZHSB2.js";import{p as S}from"./prescriptionService-CYTIh_tr.js";function de(){var h,b,v,f,u,j;const{id:n}=V(),m=B(),[D,d]=R.useState(!1),{data:o,isLoading:P,error:k}=Q({queryKey:["prescription",n],queryFn:()=>S.getPrescription(n),enabled:!!n}),t=o==null?void 0:o.data,F=s=>{if(!s||Object.keys(s).length===0)return"";let a="";return s.bp&&(a+=`<div class="vital-item"><div class="value">${s.bp}</div><div class="label">BP (mmHg)</div></div>`),s.pulse&&(a+=`<div class="vital-item"><div class="value">${s.pulse}</div><div class="label">Pulse (bpm)</div></div>`),s.temp&&(a+=`<div class="vital-item"><div class="value">${s.temp}</div><div class="label">Temp (°F)</div></div>`),s.spo2&&(a+=`<div class="vital-item"><div class="value">${s.spo2}%</div><div class="label">SpO2</div></div>`),s.weight&&(a+=`<div class="vital-item"><div class="value">${s.weight}</div><div class="label">Weight (kg)</div></div>`),`
    ...
    `,I=()=>{var N,y,w,$;if(!t)return;const s=window.open("","_blank"),a=t.prescriptionNo||"RX"+String(t.id).padStart(5,"0"),i=new Date(t.createdAt).toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"}),r=((N=t.patient)==null?void 0:N.name)||"N/A",T=((y=t.patient)==null?void 0:y.patientId)||"P"+String((w=t.patient)==null?void 0:w.id).padStart(5,"0"),C=(($=t.patient)==null?void 0:$.phone)||"N/A",L=F(t.vitalsSnapshot),M=z(t.diagnosis),U=A(t.medicines),W=H(t.labTests),q=t.clinicalNotes?`
      <div class="section">
    ...
    `:"",O=t.followUpDate?`
      <div class="followup">
        ...
        <div class="followup-date">${new Date(t.followUpDate).toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"})}</div>
      </div>
            ...
            <div class="content">
              ...
              <div class="patient-card">
                ...
                <div class="patient-details">
                  ...
                  <div class="detail-item"><label>Patient ID</label><span>${T}</span></div>
                  <div class="detail-item"><label>Phone</label><span>${C}</span></div>
